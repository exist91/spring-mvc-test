...
<form action="/join" method="post">
  <div>
    ...
    <div>
      <input id="Field1" name="name" type="text" class="field text fn" value="${member.name}" size="8" tabindex="1">
    </div>
  </div>
  ...
  <div>
    ...
    <div>
      <input id="Field3" name="email" type="email" spellcheck="false" value="${member.email}" maxlength="255" tabindex="3">
   </div>
  </div>

	<div>
		<label class="desc" id="title4" for="Field4">가입인사</label>
		<div>
		  <textarea id="Field4" name="message" spellcheck="true" rows="10" cols="50" tabindex="4">${member.message}</textarea>
		</div>
	</div>
  <div>
    <fieldset>
